...
class MdShadow extends BoxSprite implements IMdButtonComponent {
  ...
  static int QUALITY = Ac.MOBILE ? 1 : 3;
  ...
  downAction([Event e = null]) {
    if (!respondToClick || !shadowEnabled || !Ac.WEBGL) return;
    _prepareShadowAnimation();

    if (_trans != null && Ac.JUGGLER.contains(_trans)) {
      Ac.JUGGLER.remove(_trans);
    }
