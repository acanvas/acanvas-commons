...
abstract class MPagedScroll {
  ...
  void set direction(ScrollDirection direction) {
  ...
  void set tweening(bool tweening) {
    _tweening = tweening;
  }
  ...
  void set pageScrollInterval(int pageScrollInterval) {
    _pageScrollInterval = pageScrollInterval;
  }
  ...
  void set pageScrollIntervalFirst(int pageScrollIntervalFirst) {
    _pageScrollIntervalFirst = pageScrollIntervalFirst;
  }
  ...
  void set pageScrollDuration(num pageScrollDuration) {
  ...
  void set pageScrollDistance(num pageScrollDistance) {
    _pageScrollDistance = pageScrollDistance;
  }
