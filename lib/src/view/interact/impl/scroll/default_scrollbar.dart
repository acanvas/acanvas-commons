...
class DefaultScrollbar extends Scrollbar {
  ...
  void refresh() {
    if (horizontalScrollBehavior) {
      AcGraphics.rectangle(0, 0, spanSize, 10, color: MdColor.TRANSPARENT, sprite: background);
      thumb.y = 1;
    } else {
      AcGraphics.rectangle(0, 0, 10, spanSize, color: MdColor.TRANSPARENT, sprite: background);
      thumb.x = 1;
    }
