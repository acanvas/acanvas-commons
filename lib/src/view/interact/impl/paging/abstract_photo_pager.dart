...
class AbstractPhotoPager extends PagerSprite {
  ...
  static const int RASTER = 100;
  static const int WIDTH_BUTTON = 100;
  ...
  void refresh() {
    ...
    btnPrev.x = 0;
    btnPrev.y = spanHeight - RASTER;
    btnPrev.span((spanWidth / 2).round(), RASTER);

    btnNext.x = (spanWidth / 2).round();
    btnNext.y = spanHeight - RASTER;
    btnNext.span((spanWidth / 2).round(), RASTER);

    if (_tfNothingFound != null) {
      _tfNothingFound.x = buttonWidth + SPACER;
    }
  }
