...
abstract class MScroll {
  ...
  void set scrollOrientation(ScrollOrientation scrollOrientation) {
    _scrollOrientaton = scrollOrientation;
  }
  ...
  void set doubleClickEnabled(bool doubleClickEnabled) {
  ...
  void set keyboardEnabled(bool keyboardEnabled) {
  ...
  void set doubleClickToZoom(bool doubleClickToZoom) {
    _doubleClickToZoom = doubleClickToZoom;
  }
  ...
  void set maskEnabled(bool maskEnabled) {
  ...
  void set useNativeWidth(bool useNativeWidth) {
    _useNativeWidth = useNativeWidth;
  }
  ...
  void set useNativeHeight(bool useNativeHeight) {
    _useNativeHeight = useNativeHeight;
  }
  ...
  void set scrollStep(int scrollStep) {
