...
abstract class MFlow {
  ...
  void set flowOrientation(FlowOrientation flow) {
    _flow = flow;
  }
  ...
  void set distribute(bool distribute) {
  ...
  void set snapToPixels(bool snapToPixels) {
  ...
  void set inverted(bool inverted) {
    _inverted = inverted;
  }
