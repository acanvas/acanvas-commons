...
class PaperText extends UITextField {
  ...
  PaperText(String text, {int size : 14, int color : PaperColor.BLACK, String fontName : DEFAULT_FONT, int weight: 400}) : super(text, new TextFormat(fontName, size, color, weight: weight), true) {
    //format.leading = -2;
    width = 320;
  }
