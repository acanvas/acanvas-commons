...
class PaperMenu extends ListSprite {
  ...
  PaperMenu(List data, {SelectableButton cell, this.shadow : true, int backgroundColor : PaperColor.WHITE}) : super(data, cell != null ? cell : new PaperListCell(), new DefaultScrollbar(), new DefaultScrollbar()) {
