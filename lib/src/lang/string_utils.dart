...
class StringUtils {
  ...
  /**
   * <p>The maximum size to which the padding constant(can as s) expand.</p>
   */
  static const int PAD_LIMIT = 8192;
   ...
   */
  static String toInitials(String str) {
    if (isEmpty(str)) {
      return str;
    }
    return str.allMatches(r'[A-Z]/g').join('').toLowerCase();
  }
   ...
   */
  static String chompString(String str, String separator) {
    if (isEmpty(str) || separator == null) {
      return str;
    }
    return str.replaceAll(new RegExp(separator + r'$'), '');
  }
  ...
  static String deleteSpaces(String str) {
    return deleteFromString(str, new RegExp(r'\t|\r|\n|\b/g'));
  }
  ...
  static String deleteWhitespace(String str) {
    return deleteFromString(str, new RegExp(r'\s/g'));
  }

  static String deleteFromString(String str, RegExp pattern) {
    if (isEmpty(str)) {
      return str;
    }
   ...
   *  <code>null</code> if null String input
   */
  static String rightPadChar(String str, int size, String padChar) {
    if (str == null) {
      return null;
    }
    int pads = size - str.length;
   ...
   */
  static String padding(int repeat, String padChar) {
    String buffer = '';
   ...
   *  <code>null</code> if null String input
   */
  static String replace(String text, String pattern, String repl) {
   ...
   *  <code>null</code> if null String input
   */
  static String replaceTo(String text, String pattern, String repl, int max) {
   ...
   *  <code>null</code> if null String input
   */
  static String replaceOnce(String text, String pattern, String repl) {
    if (text == null || isEmpty(pattern) || repl == null) {
      return text;
    }
  ...
  static int countMatches(String str, String sub) {
    ...
    return str.allMatches('(' + sub + ')').length;
  }
  ...
  static bool contains(String str, String searchStr) {
    ...
    return new RegExp('(' + searchStr + ')').hasMatch(str);
  }
   ...
   *  false if not or <code>null</code> string input
   */
  static bool containsIgnoreCase(String str, String searchStr) {
    if (str == null || searchStr == null) {
      return false;
    }
   ...
   */
  static bool containsNone(String str, String invalidChars) {
    if (isEmpty(str) || invalidChars == null) {
      return true;
    }
    return new RegExp(r'^[^' + invalidChars + ']*\$').hasMatch(str);
  }
   ...
   */
  static bool containsOnly(String str, String validChars) {
    ...
    return new RegExp(r'^[' + validChars + ']*\$').hasMatch(str);
  }
  ...
  static bool isAlpha(String str) {
    return testString(str, new RegExp(r'^[a-zA-Z]*$'));
  }
  ...
  static bool isAlphaSpace(String str) {
    return testString(str, new RegExp(r'^[a-zA-Z\s]*$'));
  }
  ...
  static bool isAlphanumeric(String str) {
    return testString(str, new RegExp(r'^[a-zA-Z0-9]*$'));
  }
  ...
  static bool isAlphanumericSpace(String str) {
    return testString(str, new RegExp(r'^[a-zA-Z0-9\s]*$'));
  }
  ...
  static bool isNumeric(String str) {
    return testString(str, new RegExp(r'^[0-9]*$'));
  }
  ...
  static bool isNumericSpace(String str) {
    return testString(str, new RegExp(r'^[0-9\s]*$'));
  }
  ...
  static bool isWhitespace(String str) {
    return testString(str, new RegExp(r'^[\s]*$'));
  }
  ...
  static String removeEnd(String str, String remove) {
    return safeRemove(str, new RegExp(remove + r'$'));
  }
  ...
  static String removeStart(String str, String remove) {
    return safeRemove(str, new RegExp(r'^' + remove));
  }

  static String safeRemove(String str, RegExp pattern) {
    if (isEmpty(str)) {
      return str;
    }
    return str.replace(pattern, '');
   ...
   * the #equals(method as Object) would return <code>true</code>.
   * <br/>
   ...
   * strings -- that is, the value: dynamic <blockquote><pre>
   ...
   */
  static String addAt(String string, dynamic value, int position) {
   ...
   */
  static String removeAt(String string, int beginIndex, int endIndex) {
   ...
   */
  static bool hasText(String string) {
    if (string == null) {
      return false;
    }
   ...
   *
   * <p>Example: dynamic <code>
   *   print(StringUtil.leftTrimForChar("yyyymonkeyyyy", "y"); // monkeyyyy
   * </code></p>
   *
   * @param string the string to trim
   ...
   *
   * <p>Example: dynamic <code>
   *   print(StringUtil.rightTrimForChar("yyyymonkeyyyy", "y"); // yyyymonke
   * </code></p>
   *
   * @param string the string to trim
   * @param char the character to remove
  ...
  static int naturalCompare(String a, String b) {
    ...
    bool stringsAreCaseInsensitiveEqual = false;
    ...
    while (true) {
      ...
      if (stringsAreCaseInsensitiveEqual != null) {
        // If the characters are in another case (upper or lower)
        if (ca != cb) {
          if (ca.codeUnitAt(0) < cb.codeUnitAt(0)) {
            return lowerCaseBeforeUpperCase ? 1 : -1;
          } else if (ca.codeUnitAt(0) > cb.codeUnitAt(0)) {
            return lowerCaseBeforeUpperCase ? -1 : 1;
          }
        }
      }
   ...
   * Tokenizes a string to an array using the given delimiters.
   */
  static List<String> tokenizeToVector(String string, String delimiters) {
   ...
   *
   * <p>To be expected as keymap is a map like: dynamic <code>
