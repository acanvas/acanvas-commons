...
/**
	 ...
	 */
class Key extends ManagedSpriteComponent {
  //feathers
  List nameList = [];
  ...
  /**
		 ...
		 */
  Key(int charCode, [List<Key> variants = null, String type = 'characterKey', String label = null, num relativeWidth = 1, num relativeHeight = 1, Layout switchToLayoutType = null]) {
